...
public class RegisterPlayerEventNotificationValidatorTests
{
    private readonly RegisterPlayerEventNotificationValidator _validator;

    public RegisterPlayerEventNotificationValidatorTests()
    {
        _validator = new();
    }
    ...
    {
        var command = new RegisterPlayerMessageNotification(name, "email@test.com", "Password124!");
    ...
    {
        var command = new RegisterPlayerMessageNotification("name", email, "Password124!");
        var result = _validator.Validate(command);
    ...
    {
        var command = new RegisterPlayerMessageNotification("name", "email@test.com", newPassword);
        var result = _validator.Validate(command);
