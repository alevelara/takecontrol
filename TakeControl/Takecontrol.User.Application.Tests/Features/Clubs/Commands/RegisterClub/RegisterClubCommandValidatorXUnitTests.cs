...
public class RegisterClubCommandValidatorXUnitTests
{
    ...
    {
        //Arrange
        var request = new RegisterClubCommand(null, "city", "province", "mainAddress", "email@test.com", "Password123!", 1);
    ...
    {
        //Arrange
        var request = new RegisterClubCommand("", "city", "province", "mainAddress", "email@test.com", "Password123!", 1);
    ...
    {
        //Arrange
        var request = new RegisterClubCommand("name", null, "province", "mainAddress", "email@test.com", "Password123!", 1);
    ...
    {
        //Arrange
        var request = new RegisterClubCommand("name", "", "province", "mainAddress", "email@test.com", "Password123!", 1);
    ...
    {
        //Arrange
        var request = new RegisterClubCommand("name", "city", null, "mainaddress", "email@test.com", "Password123!", 1);
    ...
    {
        //Arrange
        var request = new RegisterClubCommand("name", "city", "", "mainaddress", "email@test.com", "Password123!", 1);
    ...
    {
        //Arrange
        var request = new RegisterClubCommand("name", "city", "province", null, "email@test.com", "Password123!", 1);
    ...
    {
        //Arrange
        var request = new RegisterClubCommand("name", "city", "province", "", "email@test.com", "Password123!", 1);
    ...
    {
        //Arrange
        var request = new RegisterClubCommand("name", "city", "province", "mainAddress", "email", "Password123!", 1);
    ...
    {
        //Arrange
        var request = new RegisterClubCommand("name", "city", "province", "mainAddress", "", "Password123!", 1);
    ...
    {
        //Arrange
        var request = new RegisterClubCommand("name", "city", "province", "mainAddress", null, "Password123!", 1);
    ...
    {
        //Arrange
        var request = new RegisterClubCommand("name", "city", "province", "mainAddress", "email@test.com", "", 1);
    ...
    {
        //Arrange
        var request = new RegisterClubCommand("name", "city", "province", "mainAddress", "email@test.com", null, 1);
    ...
    {
        //Arrange
        var request = new RegisterClubCommand("name", "city", "province", "mainAddress", "email@test.com", "Password12345678!", 1);
    ...
    {
        //Arrange
        var request = new RegisterClubCommand("name", "city", "province", "mainAddress", "email@test.com", "Pas1!", 1);
    ...
    {
        //Arrange
        var request = new RegisterClubCommand("name", "city", "province", "mainAddress", "email@test.com", "PASSWORD123!", 1);
    ...
    {
        //Arrange
        var request = new RegisterClubCommand("name", "city", "province", "mainAddress", "email@test.com", "Password!", 1);
