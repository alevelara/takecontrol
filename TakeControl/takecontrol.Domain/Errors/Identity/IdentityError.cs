...
public sealed class IdentityError : DomainError
{
    ...
    public static IdentityError ErrorChangingPassword = new IdentityError(1509, "Something happened while changing password.");
    public static IdentityError ErrorGeneratingUpdatePassword = new IdentityError(1510, "Something happened in generating a password update.");
}
